...
<div class="login-form" >
    <form action="login1"    method="post">
        ...
        <div class="form-group">
            <input type="password" class="form-control" id="pass_log_id" name="password" placeholder="Password" required="required">
            <%--<input id="pass_log_id" type="password" name="pass" placeholder="Password" required>--%>
            <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-password" style="text-align: right"></span>
        </div>
